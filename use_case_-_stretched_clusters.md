...
**Result:** VMs remain running because isolation response is configured to **Disabled**.
...
![](stretchedvsan1.png "Stretched Virtual SAN Configuration")
